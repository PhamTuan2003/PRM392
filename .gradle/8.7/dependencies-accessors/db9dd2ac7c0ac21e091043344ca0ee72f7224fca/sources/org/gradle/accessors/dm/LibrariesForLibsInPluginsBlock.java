...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final MaterialcolorpickerLibraryAccessors laccForMaterialcolorpickerLibraryAccessors = new MaterialcolorpickerLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>library</b> with <b>com.leavjenn.smoothdaterangepicker:library</b> coordinates and
    ...
    /**
     * Group of libraries at <b>materialcolorpicker</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public MaterialcolorpickerLibraryAccessors getMaterialcolorpicker() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForMaterialcolorpickerLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class MaterialcolorpickerLibraryAccessors extends SubDependencyFactory {

        public MaterialcolorpickerLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>library</b> with <b>com.pes.materialcolorpicker:library</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> getLibrary() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("materialcolorpicker.library");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>library</b> with value <b>0.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>libraryVersion</b> with value <b>1.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>lifecycleViewmodelAndroid</b> with value <b>2.8.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
