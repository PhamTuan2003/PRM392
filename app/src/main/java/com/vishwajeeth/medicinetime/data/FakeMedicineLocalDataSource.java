...
/**
 * Fake Medicine Local Data Source
 */
...
public class FakeMedicineLocalDataSource implements MedicineDataSource {
    ...
    private static void addMedicine(long id, int hour, int minute, String pillName, String doseQuantity,
        ...
        dayOfWeek[Calendar.getInstance().get(Calendar.DAY_OF_WEEK) - 1] = true; // Set current day

        List<Long> ids = new ArrayList<>();
        ids.add(id);

        MedicineAlarm medicineAlarm = new MedicineAlarm(id, id, pillName, hour, minute, dayOfWeek,
                doseQuantity, doseUnit, "", ids, false, alarmId);
