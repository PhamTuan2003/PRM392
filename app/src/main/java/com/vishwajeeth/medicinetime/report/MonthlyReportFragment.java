...
public class MonthlyReportFragment extends Fragment implements MonthlyReportContract.View {
    ...
    private RobotoLightTextView noMedText;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        filteringLabel = view.findViewById(R.id.filteringLabel);
        tasksLL = view.findViewById(R.id.tasksLL);
